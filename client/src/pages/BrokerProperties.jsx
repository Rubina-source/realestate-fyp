    ...
    return (
      <BrokerLayout>
        <div className="text-center py-64">
          ...
          <p className="mt-4">Loading your properties...</p>
        </div>
      </BrokerLayout>
    );
  }
              ...
              <tbody>
                {properties.map((property) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm">{property.purpose}</td>
                    ...
                    <td className="px-6 py-4 text-sm">{property.views ?? 0}</td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <Link
                          ...
                          className="h-9 px-4 py-2 bg-primary hover:bg-primary-dark cursor-pointer text-white rounded-lg flex items-center gap-2 text-xs font-medium"
                        >
                          <Eye size={16} /> View
                        </Link>
